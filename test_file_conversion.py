...
# Convert DOCX to PDF
docx_path = "input_folder\\sample2.docx" #input_pdffile_path
pdf_path = "output_folder\\output_docxtopdf_file.pdf" #output_docxfile_path 
...
# Convert PDF to DOCX
pdf_path = "input_folder\\input_file.pdf" #input_ocxfile_path
docx_path = "output_folder\\output_pdftodocx_file.docx" #output_pdffile_path 
